...
import { listMyAds, listAdLogs, getAdsStats, getAdDetail, createAd, updateAd, bulkDeleteAds, } from "../controllers/adsController.js";

const router = Router();

router.get("/track", trackByAdCode);
router.get("/ads/my", authRequired, listMyAds);
router.get("/logs", authRequired, listAdLogs);
